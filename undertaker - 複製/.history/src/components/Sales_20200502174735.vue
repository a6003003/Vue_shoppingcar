  ...
  <div id="wrapper2">
    ...
    <div id="content1">
      <div id="inner-content3">
         <h1 style="height:200px margin: auto">拍賣中心</h1>
        <el-form status-icon label-width="50px" class="demo-ruleForm">
          <el-form-item>
            請輸入物品名稱：
            <el-input v-model="goodsName" placeholder="請輸入物品名稱"></el-input>
          </el-form-item>
          ...
          <el-form-item>
            上傳日期:
            <el-date-picker v-model="goodsDate" type="date" placeholder="選擇日期"></el-date-picker>
          </el-form-item>
          <el-form-item>
