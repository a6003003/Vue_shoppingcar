<div id="shoppingcarcom1">
    <div id="img">
      <img v-bind:src="itemdata.img" alt="Smiley face" height="100" width="100" />
    </div>
    <div id="title">
      <h3>{{itemdata.item}}</h3>
    </div>
    <div id="count">
      ...
      <h3>{{itemdata.price/(itemdata.count)}}</h3>
    </div>
    <div id="buy">
      <div id="delcount">
    ...
    <div id="del">
      <button @click="delitem()">刪除</button>
    </div>
  </div>
<template>
  <div id="app">
