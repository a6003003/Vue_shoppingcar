...
<template>
  <div>
    <el-table :data="sellergoodlist" style="width: 100%" v-loading="listLoading">
      ...
      <el-table-column prop="htmlbutton" label="列印" :formatter="toHtml"></el-table-column>
