  ...
  <el-container>
    <el-header style="text-align: right; font-size: 12px">
      <div id="haha">
          ...
          <el-input v-model="input" placeholder="游戏名称" class="w120" @keyup.native="seracher(input)"></el-input>

        <el-input v-model="input" placeholder="請輸入內容"></el-input>

        <el-button style="height:40px ;

   margin: auto;" type="primary" icon="el-icon-search" @keyup.enter="seracher()" @click="seracher()">搜索</el-button>
      </div>
    </el-header>
    <el-container>
    <el-main>
    ...
    <el-carousel style="width:700px;height:400px;">
